...
public class UpdatePortfolioBO {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof UpdatePortfolioBO)) return false;
        final UpdatePortfolioBO other = (UpdatePortfolioBO) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof UpdatePortfolioBO;
    }
    ...
    public String toString() {
        return "UpdatePortfolioBO(symbol=" + this.getSymbol() + ", quantity=" + this.getQuantity() + ", price=" + this.getPrice() + ", users=" + this.getUsers() + ", action=" + this.getAction() + ")";
    }
}
